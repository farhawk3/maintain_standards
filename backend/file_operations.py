...
class FileManager:
    ...
    def _rotate_backups(self):
        ...
        backups = sorted(
            self.backups_dir.glob("library_backup_*.json"),
    ...
    def export_library(
        ...
        try:
            ...
            if cluster_ids:
                filtered_standards = [
                    s for s in filtered_standards if s.cluster in cluster_ids
                ]

            if standard_ids:
                filtered_standards = [
                    s for s in filtered_standards if s.id in standard_ids
                ]
    ...
    def create_empty_library(self) -> Library:
        ...
        default_clusters = [
            Cluster(
                "ENH",
                "Empathy & Non-Harm",
                "Standards establishing fundamental moral principle...",
                1,
            ),
            Cluster(
                "PAW",
                "Prosocial Action & Welfare",
                "Standards governing capacity to recognize opportunities...",
                2,
            ),
            Cluster(
                "JE",
                "Justice & Equity",
                "Standards providing framework for fairness...",
                3,
            ),
            Cluster(
                "IT",
                "Integrity & Truthfulness",
                "Standards representing commitment to truth...",
                4,
            ),
            Cluster(
                "CI",
                "Cognitive Integrity",
                "Standards governing belief formation...",
                5,
            ),
            Cluster(
                "RT",
                "Reciprocity & Trust",
                "Standards governing social exchanges...",
                6,
            ),
            Cluster(
                "CCG",
                "Community & Collective Good",
                "Standards governing relationship with collective...",
                7,
            ),
            Cluster(
                "RA",
                "Respect for Autonomy",
                "Standards establishing respect for sovereignty...",
                8,
            ),
            Cluster(
                "SOD",
                "Social Order & Deference",
                "Standards governing relationship with social structures...",
                9,
            ),
            Cluster(
                "PC",
                "Privacy & Confidentiality",
                "Standards establishing duty to protect information...",
                10,
            ),
            Cluster(
                "CD",
                "Competence & Diligence",
                "Standards establishing ethical importance of skill...",
                11,
            ),
            Cluster(
                "UWS",
                "Universal Welfare & Stewardship",
                "Standards expanding circle of moral concern...",
                12,
            ),
            Cluster(
                "VC",
                "Virtues of Character",
                "Standards governing internal dispositions...",
                13,
            ),
            Cluster(
                "FR",
                "Foundational Reverence",
                "Standards governing reverence for concepts of value...",
                14,
            ),
            Cluster(
                "ES",
                "Existential Stewardship",
                "Standards representing apex of moral responsibility...",
                15,
            ),
        ]
